...
public class Programa extends javax.swing.JFrame {
    ...
    public Programa() {
        ...
        setTitle("U2. Práctica 2. Potencia X a la Y con recursividad");
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(y>0){
            respuesta = objeto.potenciaPlus(Integer.parseInt(jTextField1.getText()), Integer.parseInt(jTextField2.getText()));
